...
namespace UnityEditor.FrameRecorder
{
    public class AboutBox : EditorWindow
    {
        ...
        public void OnGUI()
        {
            ...
            {
                UnityEngine.Application.OpenURL("https://github.com/Unity-Technologies/GenericFrameRecorder/blob/master/README.md");
                this.Close();
            }
            GUILayout.EndHorizontal();
            GUILayout.Space(5);
            ...
            {
                UnityEngine.Application.OpenURL("https://forum.unity.com/categories/betas-experimental-features.86/");
                this.Close();
            }
            GUILayout.EndHorizontal();
